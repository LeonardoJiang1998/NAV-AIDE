...
export const OFFLINE_ASSETS: OfflineAssetDefinition[] = [
    ...
    { key: 'pois-db', relativePath: 'pois.db', kind: 'sqlite', generatedBy: 'scripts/data-pipeline/generate-pois-db.js', required: true },
    { key: 'location-aliases-db', relativePath: 'location_aliases.db', kind: 'sqlite', generatedBy: 'scripts/data-pipeline/generate-location-aliases-db.js', required: true },
