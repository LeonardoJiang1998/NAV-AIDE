...
export const assetManifest: OfflineAssetManifestEntry[] = [
    ...
    { key: 'pois-db', path: DEVICE_DEMO_ASSETS.find((entry) => entry.key === 'pois-db')!.relativePath, checksum: 'a82a90616a01b745029c65b85e86bf7c1143867d565d68821f261e43688855fc' },
